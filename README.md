...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/oscrypto-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/oscrypto-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `oscrypto` can be installed with `conda`:
...
```
mamba install oscrypto
```

It is possible to list all of the versions of `oscrypto` available on your platform with `conda`:
...
```
mamba search oscrypto --channel conda-forge
```
...
mamba repoquery search oscrypto --channel conda-forge

# List packages depending on `oscrypto`:
mamba repoquery whoneeds oscrypto --channel conda-forge

# List dependencies of `oscrypto`:
mamba repoquery depends oscrypto --channel conda-forge
```
